    ...
    class morphology_parts_of_speech {
        ...
        private void RunEndpoint(string apiKey, string altUrl=null) {
            try {
                ...
                MorphologyEndpoint endpoint = new MorphologyEndpoint(morphology_parts_of_speech_data, MorphologyFeature.partsOfSpeech);
        ...
        static void Main(string[] args) {
            if (args.Length != 0) {
                new morphology_parts_of_speech().RunEndpoint(args[0], args.Length > 1 ? args[1] : null);
            }
            else {
