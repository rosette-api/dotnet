...
namespace Rosette.Api.Endpoints
{
    public class NameTranslation : EndpointBase<NameTranslation>
    {
        ...
        public NameTranslation SetName(string name) {
            Params[NAME] = name;
        ...
        /// <returns>this</returns>
        public NameTranslation SetEntityType(string entityType) {
        ...
        /// <returns>this</returns>
        public NameTranslation SetSourceLanguageOfOrigin(string sourceLanguageOfOrigin) {
        ...
        /// <returns>this</returns>
        public NameTranslation SetSourceLanguageOfUse(string sourceLanguageOfUse) {
        ...
        /// <returns>this</returns>
        public NameTranslation SetSourceScript(string sourceScript) {
        ...
        /// <returns>this</returns>
        public NameTranslation SetTargetLanguage(string targetLanguage) {
        ...
        /// <returns>this</returns>
        public NameTranslation SetTargetScheme(string targetScheme) {
        ...
        /// <returns>this</returns>
        public NameTranslation SetTargetScript(string targetScript) {
