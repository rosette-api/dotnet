...
public class ApiClient : IDisposable
{
    ...
    public static string Version =>
        typeof(ApiClient).Assembly.GetName().Version?.ToString() ?? "0.0.0.0";
    ...
    /// <returns>RosetteAPI object</returns>
    public ApiClient AssignConcurrentConnections(int connections) {
    ...
    /// <returns>RosetteAPI object</returns>
    public ApiClient AssignTimeout(int timeout) {
    ...
    /// <returns>RosetteAPI object</returns>
    public ApiClient SetDebug(bool state=true) {
        Debug = state;
    ...
    /// <returns>RosetteAPI object</returns>
    private ApiClient Prepare(bool forceUpdate=false) {
